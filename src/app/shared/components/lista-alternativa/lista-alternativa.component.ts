...
import { ConsultaAlternativaComponent } from '../consulta-alternativa/consulta-alternativa.component';

@Component({
  selector: 'app-lista-alternativa',
  templateUrl: './lista-alternativa.component.html',
  styleUrls: ['./lista-alternativa.component.scss']
})
export class ListaAlternativaComponent implements OnInit {
  ...
  displayedColumns: string[] = [
    ...
    'desc_metodologia_disenio','desc_material_granular', 'TRABAJAR'];
  // Datos para la lista
  ...
  openDialogInsertar(): void {
    const dialogRef = this.dialog.open(ConsultaAlternativaComponent, {
      width: '850px',
      disableClose: true,
