...
export class ConsultaListaBandejaPendienteService {
  private url = '/SIGMA-backend-desa/api/gestion/listarBandejaGestionPendiente/';
  constructor(private securityService: SecurityService ,private http: HttpClient) { }

  public consultaBandejaPendiente(): any {
    // Headers
