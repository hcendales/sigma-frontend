...
@Component({
  selector: 'app-actualizar-alternativa',
  templateUrl: './actualizar-alternativa.component.html',
  styleUrls: ['./actualizar-alternativa.component.scss']
})
export class ActualizarAlternativaComponent implements OnInit {
  public formEntity: FormGroup;
  public listas: any;
  public ready:boolean = false;
  public idAlternativaDisenio: number = 0;
  public numeroAlternativa: string = '';
  public NUMBERS_PATTERN = /^[0-9]+([.][0-9]+)*$/;
    ...
    @Inject(MAT_DIALOG_DATA) public data: {idAlternativaDisenio: number,
      ...
      this.formEntity = this.formBuilder.group({
        alternativa: this.formBuilder.group({
          ...
          espesorDisenio: ['',[Validators.required, Validators.maxLength(4), Validators.pattern(this.NUMBERS_PATTERN), Validators.min(0.00), Validators.max(2.00)]],
          cbrInicialPct: ['',[Validators.required, Validators.maxLength(4), Validators.pattern(this.NUMBERS_PATTERN), Validators.min(0), Validators.max(100)]],
        }),
        capas: this.formBuilder.array([]),
        idTipoGeosinteticos: ['',[Validators.required, Validators.maxLength(20)]],
        idTipoSistemaDrenaje: ['',[Validators.required, Validators.maxLength(20)]],
