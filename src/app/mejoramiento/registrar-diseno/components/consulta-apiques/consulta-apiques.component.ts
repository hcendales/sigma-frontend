...
@Component({
  selector: 'app-consulta-apiques',
  templateUrl: './consulta-apiques.component.html',
  styleUrls: ['./consulta-apiques.component.scss']
})
export class ConsultaApiquesComponent implements OnInit {
