...
import { BandejaGestionPendiente } from 'src/app/core/models/registro-programacion-diaria';
    ...
    this.search0.valueChanges
      .subscribe(
        valor0 => {
          ...
          this.filterValues.codigo_actividad_agrupada = '';
  ...
  creaFiltroXColumna() {
    ...
    this.dataSource.filterPredicate = ((data: any, filter: any) => {
      ...
      return (data.descripcion_zona || '').toString().toLowerCase().indexOf(searchTerms.descripcion_zona.toString().toLowerCase()) !== -1
        ...
        && (data.codigo_actividad_agrupada || '').toString().toLowerCase().indexOf(searchTerms.codigo_actividad_agrupada.toString().toLowerCase()) !== -1
